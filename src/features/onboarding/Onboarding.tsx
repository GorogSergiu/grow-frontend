...
import CreatorOnboarding from "@/features/onboarding/creator/CreatorOnboarding";
import BusinessOnboarding from "@/features/onboarding/business/BusinessOnboarding";

import type { CreatorOnboardingProfile } from "@/features/onboarding/types/creator.types";
import type { BusinessOnboardingProfile } from "@/features/onboarding/types/business.types";
import { getDefaultBusinessProfile } from "@/features/onboarding/types/business.types";
...
export default function OnboardingPage() {
  ...
  function canContinueCurrentStep() {
    ...
    if (entityType === "creator") {
      ...
      if (safeStep === 4) {
        return (
          creator.audience_age_ranges.length > 0 &&
          creator.audience_genders.length > 0 &&
      ...
      if (safeStep === 5) {
        return (
          creator.voice_styles.length > 0 &&
          creator.content_types.length > 0 &&
          creator.values_themes.length > 0
        );
      }
